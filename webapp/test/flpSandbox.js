					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Register Missing Scope ",
									"targetURL": "#registermissingscope-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"registermissingscope-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=registermissingscope",
									"url": sap.ui.require.toUrl("registermissingscope")
								}
							}
						}
					}
